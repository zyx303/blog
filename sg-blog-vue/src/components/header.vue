...
<div class="">
	...
	<div class="h-information">
				...
				<img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'static/img/f10bca462b22dc6b98915cef7c98be8f.jpg'" alt="">

		<h2 class="h-description">

					{{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"一个菜鸡的博客"}}
